...
interface PizzaModalProps {
  ...
  isOpen: boolean;
  onClose: () => void;
  onAddToCart: (pizza: Pizza, size: 'small' | 'medium' | 'large', removedIngredients: string[], extras: Extra[], customIngredients: string[]) => void;
}
...
export function PizzaModal({ pizza, isOpen, onClose, onAddToCart }: PizzaModalProps) {
  ...
  const handleAddToCart = () => {
    ...
    for (let i = 0; i < quantity; i++) {
      onAddToCart(pizza, selectedSize, removedIngredients, selectedExtras, customIngredients);
    }
        ...
        <div className="p-4 sm:p-6 space-y-6">
          ...
          {pizza.unique_price !== undefined && pizza.unique_price > 0 ? (
            <div className="bg-accent-50 p-4 rounded-lg text-center">
              ...
              <div className="text-2xl font-bold text-accent-600">{pizza.unique_price}€</div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                {pizza.prices.small > 0 && (
                  ...
                  >
                    ...
                    <div className="font-bold text-lg">{pizza.prices.small}€</div>
                  </button>
                )}
                {pizza.prices.medium > 0 && (
                  ...
                  >
                    ...
                    <div className="font-bold text-lg">{pizza.prices.medium}€</div>
                  </button>
                )}
                {pizza.prices.large > 0 && (
                  ...
                  >
                    ...
                    <div className="font-bold text-lg">{pizza.prices.large}€</div>
                  </button>
                )}
              </div>
            </>
